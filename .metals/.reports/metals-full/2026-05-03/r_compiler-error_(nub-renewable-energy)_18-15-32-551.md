...
== Source file context for tree position ==
     ...
     8 
     9   def getData(startTime: String, id: String): String = {
    10     val url = s"https://data.fingrid.fi/api/datasets/$id/data?startTime=$_CURSOR_startTime&endTime=$endTime&format=csv&locale=en&sortBy=startTime&sortOrder=desc"
...
object Main extends App {
  ...
  def getData(startTime: String, id: String): String = {

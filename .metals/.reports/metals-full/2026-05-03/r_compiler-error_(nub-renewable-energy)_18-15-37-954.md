...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree(class Null)
       tree position: line 9 of file://<HOME>/Documents/University/Year%202/Semester%202/Introduction%20to%20Functional%20Programming/Project/nub-renewable-energy/src/main/scala/Main.scala
            tree tpe: Null
              symbol: (final abstract) class Null in package scala
   symbol definition: final abstract class Null extends AnyRef (a NullClass$)
      symbol package: scala
       symbol owners: class Null
           call site: <none> in <none>

== Source file context for tree position ==

     6   private val env = Dotenv.load()
     7   private val apiKey = env.get("FINGRID_PRIMARY")
     8 
     9   def getData(startTime: String, endTime: id: String): String = {
...
object Main extends App {
  ...
  def getData(startTime: String, endTime: id: String): String = {
